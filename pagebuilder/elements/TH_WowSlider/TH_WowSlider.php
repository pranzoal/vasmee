	...
	function options()
	{
		...
		$options = array(
			...
			'help' => znpb_get_helptab( array(
				'video'   => sprintf( '%s', esc_url('https://my.hogash.com/video_category/kallyas-wordpress-theme/#wQ_XfgfzRwk') ),
				'docs'    => sprintf( '%s', esc_url('https://my.hogash.com/documentation/wow-slider/') ),
				'copy'    => $uid,
				'general' => true,
			)),
