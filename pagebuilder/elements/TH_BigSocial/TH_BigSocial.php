...
class TH_BigSocial extends ZnElements
{
	...
	function element()
	{
		...
		?>
		<div class="bigsocialblock <?php echo implode(' ', $classes); ?>" <?php echo zn_get_element_attributes($options); ?>>
			<?php
	...
	function options()
	{
		...
		return array (
			...
			'help' => znpb_get_helptab( array(
				'video'   => sprintf( '%s', esc_url('https://my.hogash.com/video_category/kallyas-wordpress-theme/#vY3eAPhmbcY') ),
				'docs'    => sprintf( '%s', esc_url('https://my.hogash.com/documentation/big-social-blocks/') ),
				'copy'    => $uid,
				'general' => true,
			))
		);
